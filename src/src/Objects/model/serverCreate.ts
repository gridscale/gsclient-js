...
export interface ServerCreate { 
     ...
     */
    hardwareProfile?: ServerCreate.HardwareProfileEnum;
}
export namespace ServerCreate {
    export type HardwareProfileEnum = 'default' | 'nested' | 'legacy' | 'cisco_csr' | 'sophos_utm' | 'f5_bigip' | 'q35' | 'q35_nested';
    export const HardwareProfileEnum = {
        Default: 'default' as HardwareProfileEnum,
        Nested: 'nested' as HardwareProfileEnum,
        Legacy: 'legacy' as HardwareProfileEnum,
        CiscoCsr: 'cisco_csr' as HardwareProfileEnum,
        SophosUtm: 'sophos_utm' as HardwareProfileEnum,
        F5Bigip: 'f5_bigip' as HardwareProfileEnum,
        Q35: 'q35' as HardwareProfileEnum,
        Q35Nested: 'q35_nested' as HardwareProfileEnum
    };
}
