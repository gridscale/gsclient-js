...
import { PaasServiceTemplateResources } from './paasServiceTemplateResources';


export interface PaasServiceTemplate { 
    /**
     ...
     */
    status?: string;
    parametersSchema?: PaasServiceParametersSchema;
}
