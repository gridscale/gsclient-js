...
export interface MarketplaceApplication { 
     ...
     */
    publishedGlobalDate?: Date;
    /**
     * Category of marketplace application
     */
    category?: MarketplaceApplication.CategoryEnum;
...
export namespace MarketplaceApplication {
    export type CategoryEnum = 'CMS' | 'project management' | 'Adminpanel' | 'Collaboration' | 'Cloud Storage' | 'Archiving';
    export const CategoryEnum = {
        CMS: 'CMS' as CategoryEnum,
        ProjectManagement: 'project management' as CategoryEnum,
        Adminpanel: 'Adminpanel' as CategoryEnum,
        Collaboration: 'Collaboration' as CategoryEnum,
        CloudStorage: 'Cloud Storage' as CategoryEnum,
        Archiving: 'Archiving' as CategoryEnum
    };
}
