...
export declare namespace MarketplaceApplication {
    type CategoryEnum = 'CMS' | 'project management' | 'Adminpanel' | 'Collaboration' | 'Cloud Storage' | 'Archiving';
    const CategoryEnum: {
        CMS: CategoryEnum;
        ProjectManagement: CategoryEnum;
        Adminpanel: CategoryEnum;
        Collaboration: CategoryEnum;
        CloudStorage: CategoryEnum;
        Archiving: CategoryEnum;
    };
}
