...
interface MarketplaceApplication {
    ...
    create(_attributes: models.MarketplaceApplicationCreate, _callback?: Function): Promise<ApiResult<models.MarketplaceApplicationCreateResponse>>;
    patch(_uuid: string, _attributes: models.MarketplaceApplicationUpdate, _callback?: Function): Promise<ApiResult<VoidApiResult>>;
}
declare class MarketplaceApplication extends GridscaleObjects {
